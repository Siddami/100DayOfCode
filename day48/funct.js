//get input box, select, and button
...
button.addEventListener('click', () => {
    ...
    if(input.value.trim() === "" || selectedValue === "none") {
        ...
        if (flexContainer.contains(images)) {
    ...
    switch(selectedText){
        case 'MERCURY': planetImage.src = "./image/mercury.png"; break;
        case 'VENUS': planetImage.src = "./image/venus.png"; break;
        case 'EARTH': planetImage.src = "./image/earth.png"; break;
        case 'MOON': planetImage.src = "./image/moon.png"; break;
        case 'MARS': planetImage.src = "./image/mars.png"; break;
        case 'JUPITER': planetImage.src = "./image/jupiter.png"; break;
        case 'SATURN': planetImage.src = "./image/saturn.png"; break;
        case 'URANUS': planetImage.src = "./image/uranus.png"; break;
        case 'NEPTUNE': planetImage.src = "./image/neptune.png"; break;
        case 'PLUTO': planetImage.src = "./image/pluto.png"; break;
    }
    ...
    if(gravityConstants.hasOwnProperty(selectedText)){
        ...
        description.innerHTML = `<p>The Weight of the Object on <strong>${selectedText}</strong> is <span>${weight}.00 N</span></p>`;
